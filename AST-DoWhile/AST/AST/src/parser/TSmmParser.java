// Generated from C:/Users/nati6/OneDrive/Escritorio/Informatica/4 Curso/Segundo Semestre/DLP/DLP-PL/Examen/AST-DoWhile/AST/AST/src/parser/TSmm.g4 by ANTLR 4.13.2
package parser;
...
public class TSmmParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'*'", "'/'", "'%'", "'+'", "'>'", "'>='", "'<'", "'<='", "'!='", "'=='", 
			"'&&'", "'||'", "'log'", "';'", "'input'", "'='", "'while'", "'if'", 
			"'else'", "'do'", "'return'", "'{'", "'}'", "'int'", "'number'", "'char'", 
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				setState(200);
				match(T__1);
				_localctx.ast.add(new DoWhile(((StatementContext)_localctx).e1.ast, ((StatementContext)_localctx).b1.ast, ((StatementContext)_localctx).e1.ast.getLine(), ((StatementContext)_localctx).e1.ast.getColumn()));
				}
				break;
			case 8:
