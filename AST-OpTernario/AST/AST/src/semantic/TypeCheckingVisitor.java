...
//    }
     ...
     *     (21) expr2.type.mustBeLogical()
     *          expr1.type = expr3.type.commonType(expr4.type)
     */
    @Override
    public Void visit(TernaryOperator t, Type param){
        super.visit(t, param);
        t.getLeft().getType().mustBeLogical(t.getLeft());
        t.setType(t.getRightTrue().getType().commonType(t.getRightFalse().getType(), t));
        return null;
    }
