...
statement returns [List<Statement> ast = new ArrayList<Statement>()] locals[List<Expression>args = new ArrayList<Expression>(),
          ...
          // EJERCICIO: FOR
          | 'for' '('  a1=assigmentFor ';' e1=expression ';' a2=assigmentFor ')' b1=body
                {$ast.add(new For($a1.ast, $e1.ast, $a2.ast, $b1.ast, $e1.ast.getLine(), $e1.ast.getColumn()));}
          // Return
...
assigmentFor returns [Statement ast]:
        e1=expression '=' e2=expression
           {$ast = new Assigment($e1.ast, $e2.ast, $e1.ast.getLine(), $e1.ast.getColumn());}
        ;
