// Generated from C:/Users/nati6/OneDrive/Escritorio/Informatica/4 Curso/Segundo Semestre/DLP/DLP-PL/Examen/AST-For/AST/AST/src/parser/TSmm.g4 by ANTLR 4.13.2
package parser;
...
public class TSmmParser extends Parser {
	...
	public static final int
		RULE_program = 0, RULE_expression = 1, RULE_statement = 2, RULE_assigmentFor = 3, 
		RULE_body = 4, RULE_type = 5, RULE_simple_type = 6, RULE_recordField = 7, 
		RULE_definition = 8, RULE_functionDefinition = 9, RULE_bodyFunction = 10, 
		RULE_params = 11, RULE_varDefinition = 12, RULE_ids = 13, RULE_mainDefinition = 14;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "expression", "statement", "assigmentFor", "body", "type", 
			"simple_type", "recordField", "definition", "functionDefinition", "bodyFunction", 
			"params", "varDefinition", "ids", "mainDefinition"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'*'", "'/'", "'%'", "'+'", "'>'", "'>='", "'<'", "'<='", "'!='", "'=='", 
			"'&&'", "'||'", "'log'", "';'", "'input'", "'='", "'while'", "'if'", 
			"'else'", "'for'", "'return'", "'{'", "'}'", "'int'", "'number'", "'char'", 
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public Token ID;
		public AssigmentForContext a1;
		public AssigmentForContext a2;
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public TerminalNode ID() { return getToken(TSmmParser.ID, 0); }
		public List<AssigmentForContext> assigmentFor() {
			return getRuleContexts(AssigmentForContext.class);
		}
		public AssigmentForContext assigmentFor(int i) {
			return getRuleContext(AssigmentForContext.class,i);
		}
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				match(T__0);
				setState(200);
				((StatementContext)_localctx).a1 = assigmentFor();
				setState(201);
				match(T__22);
				setState(202);
				((StatementContext)_localctx).e1 = expression(0);
				...
				match(T__22);
				setState(204);
				((StatementContext)_localctx).a2 = assigmentFor();
				setState(205);
				match(T__1);
				setState(206);
				((StatementContext)_localctx).b1 = body();
				_localctx.ast.add(new For(((StatementContext)_localctx).a1.ast, ((StatementContext)_localctx).e1.ast, ((StatementContext)_localctx).a2.ast, ((StatementContext)_localctx).b1.ast, ((StatementContext)_localctx).e1.ast.getLine(), ((StatementContext)_localctx).e1.ast.getColumn()));
				}
				break;
			case 8:
	...
	@SuppressWarnings("CheckReturnValue")
	public static class AssigmentForContext extends ParserRuleContext {
		...
		public AssigmentForContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_assigmentFor; }
	}

	public final AssigmentForContext assigmentFor() throws RecognitionException {
		AssigmentForContext _localctx = new AssigmentForContext(_ctx, getState());
		enterRule(_localctx, 6, RULE_assigmentFor);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(216);
			((AssigmentForContext)_localctx).e1 = expression(0);
			setState(217);
			match(T__24);
			setState(218);
			((AssigmentForContext)_localctx).e2 = expression(0);
			((AssigmentForContext)_localctx).ast =  new Assigment(((AssigmentForContext)_localctx).e1.ast, ((AssigmentForContext)_localctx).e2.ast, ((AssigmentForContext)_localctx).e1.ast.getLine(), ((AssigmentForContext)_localctx).e1.ast.getColumn());
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final BodyContext body() throws RecognitionException {
		...
		try {
			...
			case T__30:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 127545181733634L) != 0)) {
					{
					{
					setState(225);
	...
	public final BodyFunctionContext bodyFunction() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_bodyFunction);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
