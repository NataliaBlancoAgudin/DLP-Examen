...
public class ExecuteCGVisitor extends AbstractCGVisitor<Void, FunctionDefinition> {
    ...
    /**
     * execute[[For: stmt1 -> stmt2 expr1 stmt3 stmt4*]]()=
     *         <#line> expr.line
     *         <' * For>
     *         String cond = cg.getLabel()
     *         String end = cg.getLabel()
     ...
     *         cond <:>
     *         value[[expr1]]()
     *         cg.convertTo(expr1.type, IntType)
     *         <jz> end
    ...
    public Void visit(For f, FunctionDefinition param) {
        ...
        getCodeGenerator().insertLabel(cond);
        f.getCondicion().accept(valueCGVisitor, null);
        getCodeGenerator().convertTo(f.getCondicion().getType(), IntType.getInstance());
        getCodeGenerator().jz(end);
