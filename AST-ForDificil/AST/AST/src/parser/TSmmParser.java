// Generated from C:/Users/nati6/OneDrive/Escritorio/Informatica/4 Curso/Segundo Semestre/DLP/DLP-PL/Examen/AST-ForDificil/AST/AST/src/parser/TSmm.g4 by ANTLR 4.13.2
package parser;
...
public class TSmmParser extends Parser {
	...
	public static final int
		...
		RULE_assigmentFor = 4, RULE_body = 5, RULE_type = 6, RULE_simple_type = 7, 
		RULE_recordField = 8, RULE_definition = 9, RULE_functionDefinition = 10, 
		RULE_bodyFunction = 11, RULE_params = 12, RULE_varDefinition = 13, RULE_ids = 14, 
		RULE_mainDefinition = 15;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "expression", "statement", "varDefinitionAs", "assigmentFor", 
			"body", "type", "simple_type", "recordField", "definition", "functionDefinition", 
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public AssigmentForContext assigmentFor() {
			return getRuleContext(AssigmentForContext.class,0);
		}
	...
	public final AssigmentForContext assigmentFor() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_assigmentFor);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(224);
