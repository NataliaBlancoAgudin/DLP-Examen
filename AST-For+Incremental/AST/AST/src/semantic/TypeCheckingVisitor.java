...
//    }
     ...
     */
    @Override
    public Void visit(Post p, Type param) {
        super.visit(p, param);
        p.getExpression().getType().mustPromotesTo(IntType.getInstance(), p);
        return null;
    }
     ...
     */
    @Override
    public Void visit(VarDefinitionWithAssigment v, Type param) {
        super.visit(v, param);
        v.getExp().getType().mustPromotesTo(v.getVar().getType(), v);
        return null;
    }
}
