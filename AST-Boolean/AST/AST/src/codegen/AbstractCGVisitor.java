...
public abstract class AbstractCGVisitor <RT,PT> implements Visitor<RT,PT> {
    ...
    // EJERCICIO
    @Override
    public RT visit(BooleanLiteral r, PT param) {
        throw new UnsupportedOperationException("Code generation no implementa para el nodo: " + r.getClass().getSimpleName());
    }

    @Override
    public RT visit(BooleanType b, PT param) {
        throw new UnsupportedOperationException("Code generation no implementa para el nodo: " + b.getClass().getSimpleName());
    }
}
