...
public class Main {
    ...
    public static void main(String... args) throws Exception {
        ...
        if (ErrorHandler.getInstance().anyError()) {
			...
			// Tenemos el nombre del fichero output/salida (args[1]) y el fichero input/entrada (args[0])
			// Cuando generemos el output debemos ejecutarlo en la mapa virtual (MAPL)
